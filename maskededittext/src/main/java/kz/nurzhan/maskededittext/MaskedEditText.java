...
public class MaskedEditText extends AppCompatEditText {
    ...
    public interface MaskedTextWatcher {
    ...
    private class MaskTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if(maskedTextWatcher !=null){
                maskedTextWatcher.afterTextChanged(s);
            }
        }
        ...
        public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            if(maskedTextWatcher !=null){
                maskedTextWatcher.beforeTextChanged(MaskedEditText.this, s, start,count,after);
            }
        }
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            if(maskedTextWatcher !=null){
                maskedTextWatcher.onTextChanged(MaskedEditText.this, s, start,before,count);
            }
        }
    }
